...
#===================================limit=========================================
 			elif sample_standard['parameter']=='JVMReuse':
	                	x_sample.append(int(1))

			elif sample_standard['parameter']=='ReduceHeapSize':
				x_sample.append(MapSize)
...
#================================limit===========================================
                                if sample_standard['parameter']=='MapHeapSize':
					MapSize=x
				if sample_standard['parameter']=='MapTasksMax':
	                        	x=2
				if sample_standard['parameter']=='inMenMergeThreshold':
					x=1000
...
#=======================================limit=====================================
				...
				if sample_standard['parameter']=='ShuffleInputPer':
					x=0.7
                                if sample_standard['parameter']=='SortPer':
					x=0.8
