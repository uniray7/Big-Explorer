...
class Log:
	...
	def RefineRawJson(self):
		...
		refine_config_set = {'SplitSize':JobProperty[SplitSize],'SortMB':JobProperty[SortMB],'SortPer':JobProperty[SortPer],'ReduceHeapSize':JobProperty[ReduceHeapSize],'ReduceTasksMax':JobProperty[ReduceTasksMax],'ReduceTasksNum':JobProperty[ReduceTasksNum],'JVMReuse':JobProperty[JVMReuse]}
	...
	def RefineJsonSaveInDB(self):
		...
		BigDB = conn.big
		wordcount_model = BigDB.word_low
