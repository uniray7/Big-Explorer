...
#		print refine_log_data
	...
	def RefineJsonSaveInDB(self):
		...
		BigDB = conn.big
		terasort_model = BigDB.terasort_model
		

		refine_log_data = self.RefineRawJson()
#		print refine_log_data

		insert_id =terasort_model.insert(refine_log_data)
...
#	serial_num = log_dir[log_dir.find('_')+1:]
...
for i in range(710):
	...
	log_path = current_path+'/logs/log_'+str(i)
	new_log = Log(log_path,i)
