...
class Log:
	...
	def RefineRawJson(self):
		...
		refine_config_set = {'MapHeapSize':JobProperty[MapHeapSize],'SplitSize':JobProperty[SplitSize],'SortMB':JobProperty[SortMB],'SortPer':JobProperty[SortPer],'RecordPer':JobProperty[RecordPer],'ReduceHeapSize':JobProperty[ReduceHeapSize],'ReduceTasksMax':JobProperty[ReduceTasksMax],'ReduceTasksNum':JobProperty[ReduceTasksNum],'ShuffleMergePer':JobProperty[ShuffleMergePer],'ReduceSlowstart':JobProperty[ReduceSlowstart],'ReduceInputPer':JobProperty[ReduceInputPer],'JVMReuse':JobProperty[JVMReuse]}
	...
	def RefineJsonSaveInDB(self):
		...
		BigDB = conn.big
		wordcount_model = BigDB.word_med
